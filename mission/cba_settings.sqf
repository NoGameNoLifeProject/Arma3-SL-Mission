// 3AS
force force TAS_jetcoolset = 3;
force force TAS_jetfuelset = 3;
force force TAS_jetheatset = 1;
force force TAS_jetsoundvol = 0.1;
...
force force ace_vehiclelock_defaultLockpickStrength = 1;
force force ace_vehiclelock_lockVehicleInventory = true;
force force ace_vehiclelock_vehicleStartingLockState = 0;
...
// ACE Гранаты
force force ace_grenades_convertExplosives = false;
...
force force ace_map_gestures_interval = 1;
...
force force ace_zeus_radioOrdnance = true;
...
force force ace_cargo_paradropTimeCoefficent = 10;
...
force force ace_repair_repairDamageThreshold = 0.5;
...
force force ace_medical_blood_maxBloodObjects = 1000;
...
force force ace_medical_gui_maxDistance = 10;
...
force force ace_common_checkPBOsWhitelist = "['MySQLExt']";
...
force force ace_trenches_smallEnvelopeDigDuration = 10;
force force ace_trenches_smallEnvelopeRemoveDuration = 5;
...
force force ace_winddeflection_simulationInterval = 0;
...
force force ace_switchunits_safeZoneRadius = 0;
...
force force ace_weather_updateInterval = 0;
...
force force ace_hearing_earplugsVolume = 0.3;
...
force force ace_finger_maxRange = 15;
...
force force grenades_hatches_main_allowedGrenadesSetting = "['212th_thermaldet','3AS_BaridumCore','ls_mag_classC_thermalDet','ls_mag_classB_thermalDet','ls_mag_classA_thermalDet','RD501_imploder_x1_mag','RD501_impacter_x1_mag','RD501_thermaldet_x1_mag','RD501_thermaldet_cis_x1_mag','442_thermal_det_belt_5_mag','442_thermal_det_belt_10_mag','442_thermal_det_mag','3AS_ThermalDetonator','442_impact_belt_5_mag','442_impact_belt_10_mag','442_impact_mag','HandGrenade','OPTRE_M9_Frag','RD501_throwable_c_type_x1_mag','3AS_ThrowableCharge','MEOP_biotic_HandGrenade','ACE_M14','MEOP_frag_HandGrenade','SC_IG3','ls_mag_n20_thermalDet','MiniGrenade']";
...
force force grenades_hatches_main_damageDealtCrew = 23.2008;
force force grenades_hatches_main_damageDealtCrewVanilla = 1;
...
force force ace_laser_dispersionCount = 0;
...
Achilles_var_Achilles_Change_Altitude_Module = false;
Achilles_var_Achilles_Chatter_Module = true;
Achilles_var_Achilles_Create_Universal_Target_Module = true;
force force Achilles_var_Achilles_DevTools_FunctionViewer = false;
force force Achilles_var_Achilles_DevTools_ShowInAnimViewer = false;
force force Achilles_var_Achilles_DevTools_ShowInConfig = false;
...
Achilles_var_Achilles_Module_Equipment_Attach_Dettach_Effect = false;
...
Achilles_var_Achilles_Module_Spawn_Carrier = false;
Achilles_var_Achilles_Module_Spawn_Destroyer = false;
...
Achilles_var_Achilles_SurrenderUnit_Module = false;
Achilles_var_Achilles_Toggle_Simulation_Module = true;
Achilles_var_Achilles_Transfer_Ownership_Module = false;
...
Achilles_var_Ares_Module_Equipment_Flashlight_IR_ON_OFF = false;
Achilles_var_Ares_Module_Equipment_NVD_TACLIGHT_IR = true;
Achilles_var_Ares_Module_Equipment_Turret_Optics = false;
...
Achilles_var_Ares_Module_Spawn_Submarine = false;
Achilles_var_Ares_Module_Spawn_Trawler = false;
...
Achilles_var_198_ab = true;
Achilles_var_212_Arcus_B1_Faction = true;
Achilles_var_212_Arcus_BX_Faction = true;
...
Achilles_var_JMM_f_ox02_o_faction = true;
Achilles_var_JMM_f_pdf_b_faction = true;
...
Achilles_var_MEOP_ERCS = true;
Achilles_var_MEOP_geth = true;
Achilles_var_MEOP_human = true;
Achilles_var_MEOP_humanDes = true;
Achilles_var_MEOP_humanI = true;
Achilles_var_MEOP_humanWood = true;
...
Achilles_var_MEOP_valluv = true;
Achilles_var_MEOP_wild = true;
...
Achilles_var_RD501_ind_Faction = true;
...
Achilles_var_SC_Faction_AC = true;
Achilles_var_SC_Faction_AR = true;
Achilles_var_SC_Faction_SE = true;
...
Achilles_var_setRadioFrequenciesSR_Default = "30";
...
force force AUR_ADVANCED_RAPPELING_NEW_ACTION = true;
...
// AIME Ammo Type Menu
UPSL_aime_change_ammo_setting_ammo_class = false;
UPSL_aime_change_ammo_setting_vehicle_ammo_class = false;

// AIME General
UPSL_aime_setting_hide = false;

// AIME GPS and UAV Terminal
UPSL_aime_uav_terminal_setting_gps_action = false;
UPSL_aime_uav_terminal_setting_term_action = false;
UPSL_aime_uav_terminal_setting_uav_action = false;

// AIME Group Management
UPSL_aime_group_setting_drop_leader_action = true;

// AIME Inventory
UPSL_aime_inventory_setting_assemble_action = false;
UPSL_aime_inventory_setting_backpack_action = false;
UPSL_aime_inventory_setting_holder_action = true;
UPSL_aime_inventory_setting_open_action = false;

// AIME Vehicle Controls
UPSL_aime_vehicle_controls_setting_arty_computer_action = false;
UPSL_aime_vehicle_controls_setting_collision_action = false;
UPSL_aime_vehicle_controls_setting_engine_action = false;
UPSL_aime_vehicle_controls_setting_flaps_action = false;
UPSL_aime_vehicle_controls_setting_gear_action = false;
UPSL_aime_vehicle_controls_setting_hover_action = false;
UPSL_aime_vehicle_controls_setting_lights_action = false;
UPSL_aime_vehicle_controls_setting_manual_action = false;
UPSL_aime_vehicle_controls_setting_user_actions = false;

// AIME Vehicle Seats
UPSL_aime_vehicle_seats_setting_change_action = true;
UPSL_aime_vehicle_seats_setting_force_eject = true;
UPSL_aime_vehicle_seats_setting_getin_action = false;
UPSL_aime_vehicle_seats_setting_getout_action = false;
...
force force IMS_BayonetDistance = "0";
...
JLTS_settings_EMP_notifyPlayer = false;
force force JLTS_settings_EMP_repairTimeHandgun = 15;
force force JLTS_settings_EMP_repairTimePrimary = 15;
force force JLTS_settings_EMP_repairTimeSecondary = 15;
...
force force JLTS_settings_jumppack_stances = 2;
...
force force kat_airway_probability_obstruction = 10;
...
force force kat_breathing_spo2_big_value = 10;
force kat_breathing_SpO2_dieActive = true;
force kat_breathing_SpO2_dieValue = 65;
force force kat_breathing_spo2_small_value = 4;
...
force force kat_circulation_CPR_Chance_Default = 80;
force force kat_circulation_CPR_Chance_Doctor = 80;
force force kat_circulation_CPR_Chance_RegularMedic = 80;
...
force force kat_circulation_SuccesCh_AED = 100;
force force kat_circulation_SuccesCh_AED_X = 100;
...
force force IMS_LightSabers_GlobalDamageKnight = "75";
force force IMS_LightSabers_GlobalDamageMaster = "100";
force force IMS_LightSabers_GlobalDamagePadawan = "50";
force force IMS_LightSabers_Mana_Knight = "0.002";
force force IMS_LightSabers_Mana_Master = "0.002";
force force IMS_LightSabers_Mana_Padawan = "0.002";

// RD501
rd501_awacs_UpdateRate = 1;
force force rd501_fortify_useAmmo = false;
force force rd501_fortify_usePreset = false;
force force rd501_medical_notification_enabled = false;
force force rd501_medical_notification_message = "%1 is asking that you kindly hold still.";
rd501_mfd_colours_custom = [0.5,0.5,0.5];
rd501_mfd_colours_custom_alpha = 1;
force force RD501_ZL_Enabled = false;

// RD501 Radio Dialog Selector
RD501_Radio_Dialog_Selector_Dialog = "JLTS_clone_rto_radio_dialog";
RD501_Radio_Dialog_Selector_Enabled = true;

// Scion Conflict
force force sc_scripts_grapplinghook_coolDown = 0;
force force sc_scripts_grapplinghook_everyoneHasGrapplingHook = false;
force force sc_scripts_grapplinghook_grapplingSpeedCoef = 5;
force force sc_scripts_grapplinghook_maxGrapplingTime = 15;
...
force force sc_scripts_jumppack_dodgeMultiplier = 50;
force force sc_scripts_jumppack_everyoneHasJumpPack = false;
force force sc_scripts_jumppack_jumpCooldown = 30;
force force sc_scripts_jumppack_maxJumpHeightHigh = 100;
force force sc_scripts_jumppack_maxJumpHeightLow = 100;
force force sc_scripts_jumppack_maxJumpVelocityMultiplier = 50;
force force sc_scripts_jumppack_useACEOverpressure = true;

// slBacta
force force slBacta_bactaItem = "442_BactaPack";
force force slBacta_cooldown = 600;
force force slBacta_uniform = "SLTEAM_Gouts_uni,SLTEAM_Grimaks_uni,JMSSL_Commando_bear_a_uni,SLTEAM_RC_Nek_uni,SLTEAM_RC_Guard_uniform,SLTEAM_Ghost_Squad_RC_Uniform,SLTEAM_Dice_Commando_uni,SLTEAM_RC104_16_uni,SLTEAM_RC104_10_uni,SLTEAM_RC104_28_uni,JMSSL_Commando_eb03_uni,JMSSL_Commando_nek_uni,JMSSL_Commando_eb04_uni,SLTEAM_502_RC_Uniform,SLTEAM_05B_RC_Uniform,JMSSL_Commando_nemesis_uni,JMSSL_Commando_sev_uni,JMSSL_Commando_scorch_uni,JMSSL_Commando_omega_uni,JMSSL_Commando_niner_uni,JMSSL_Commando_fox_1_uni,JMSSL_Commando_fox_4_uni,JMSSL_Commando_fox_2_uni,JMSSL_Commando_fox_3_uni,JMSSL_Commando_fixer_uni,JMSSL_Commando_boss_uni,JMSSL_Commando_bear_uni,JMSSL_Commando_base_F_CombatUniform,SLDT_RCBase_Gud,JMSSL_Commando_bear_uni_w,JMSSL_Commando_bear_uni_w_11,JMSSL_Commando_bear_uni_w_base,JMSSL_Commando_bear_uni_04,SLTEAM_13th_RC_Uniform,JMSSL_Commando_acklay_uni,JMSSL_Commando_05B_uni_71";
force force slBacta_use = 3;

// OPTRE Powered MJOLNIR
force force OPTRE_HELMET_HUD_EVA = "JMSSL_Commando_bear_helmet_02_w,JMSSL_Commando_bear_helmet_base_w,JMSSL_Commando_Nek_helmet,SLTEAM_Ghost_Squad_RC_Helmet,JMSSL_Commando_EB03_helmet,SLTEAM_502_RC_Helmet,JMSSL_Commando_sev_helmet,JMSSL_Commando_scorch_helmet,JMSSL_Commando_omega_helmet,JMSSL_Commando_niner_helmet,JMSSL_Commando_Fox_1_helmet,JMSSL_Commando_Fox_3_helmet,JMSSL_Commando_Fox_2_helmet,JMSSL_Commando_Fox_4_helmet,JMSSL_Commando_fixer_helmet,JMSSL_Commando_boss_helmet,JMSSL_Commando_bear_helmet,JMSSL_Commando_base_helmet,SLTEAM_05B_RC_Helmet,JMSSL_Commando_camo2_helmet,SLTEAM_Commando_Guard_helmet_Mario,SLTEAM_Commando_Guard_helmet_Leo,SLTEAM_Commando_Guard_helmet_Nate,SLTEAM_Commando_Guard_helmet_Stalker,SLTEAM_RC104_helmet16,SLTEAM_RC104_helmet28,SLTEAM_RC104_helmet10,SLTEAM_RC_Nek_Helmet,JMSSL_Commando_EB04_helmet,SLTEAM_RC_Guard_helmet,SLTEAM_RC104_helmet96,SLTEAM_13th_RC_Helmet,JMSSL_Commando_acklay_helmet,JMSSL_Commando_bear_helmet_11_w,JMSSL_Commando_bear_helmet_assault_w,JMSSL_Commando_bear_helmet_medic_w,SLTEAM_Commando_bear_a_helmet,SLTEAM_RC_Blue_Helmet,SLTEAM_RC_Kama_Helmet,JMSSL_Commando_nem_helmet,SLTEAM_RC_OrangeGreen_Helmet,SLTEAM_RC_RedGold_Helmet,SLTEAM_RC_Nek_Helmet,JMSSL_Commando_bear_helmet_04,JMSSL_Commando_05B_helmet_71";
force force OPTRE_HELMET_HUD_MARKIV = "OPTRE_MJOLNIR_Mk4Helmet,OPTRE_MJOLNIR_Mk4Helmet_Blue,OPTRE_MJOLNIR_Mk4Helmet_Red,ls_skirata_mandalorian_traditional_helmet";
force force OPTRE_HELMET_HUD_MARKV = "OPTRE_FC_MJOLNIR_MKV_Helmet,OPTRE_FC_MJOLNIR_MKV_Helmet_Black,OPTRE_FC_MJOLNIR_MKV_Helmet_117,OPTRE_FC_MJOLNIR_MKV_Helmet_Caboose,OPTRE_FC_MJOLNIR_MKV_Helmet_Freeman,OPTRE_FC_MJOLNIR_MKV_Helmet_Church,OPTRE_FC_MJOLNIR_MKV_Helmet_Donut,OPTRE_FC_MJOLNIR_MKV_Helmet_Simmons,OPTRE_FC_MJOLNIR_MKV_Helmet_Night,OPTRE_FC_MJOLNIR_MKV_Helmet_Olive,OPTRE_FC_MJOLNIR_MKV_Helmet_Grif,OPTRE_FC_MJOLNIR_MKV_Helmet_Sarge,OPTRE_FC_MJOLNIR_MKV_Helmet_Tucker,SLTEAM_Misk_JMSSL_Clonetrooper_P1_helmet,JMSSL_Clonetrooper_P1_Ep2serg_helmet,JMSSL_Clonetrooper_P1_Ep2lt_helmet,JMSSL_Clonetrooper_P1_Ep2cap_helmet,JMSSL_Clonetrooper_P1_Ep2com_helmet,SLTEAM_M10_CPT_P1_helmet,SLTEAM_M10_CPT_P1_helmet2,SLTEAM_M10_Night_P1_helmet,SLTEAM_M10_Clonetrooper_P1_helmet1,SLTEAM_M10_Clonetrooper_P1_helmet2,SLTEAM_M10_Clonetrooper_P1_helmet3,SLTEAM_M10_Clonetrooper_P1_helmet4";
force force OPTRE_HELMET_HUD_MARKVB = "OPTRE_MJOLNIR_MkVBHelmet";
force force OPTRE_HELMET_HUD_MARKVI = "OPTRE_FC_MJOLNIR_Mark_VI_Helmet,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_White,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Olive,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Tan,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Tex,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Caboose,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Church,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Donut,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Grif,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Simmons,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Sarge,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Kaikaina,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Lopez,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Doc,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_North,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_South,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_York,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Washington,OPTRE_FC_MJOLNIR_Mark_VI_Helmet_Tucker";
force force OPTRE_HELMET_HUD_MP = "OPTRE_MJOLNIR_MPHelmet";
force force OPTRE_HELMET_HUD_RECON = "OPTRE_MJOLNIR_ReconHelmet";
force force OPTRE_HELMET_HUD_SANGHEILI = "OPTRE_FC_Elite_Helmet_FieldMarshal,OPTRE_FC_Elite_Helmet_HonorGuard_Ultra,OPTRE_FC_Elite_Helmet_HonorGuard,OPTRE_FC_Elite_Helmet_Major,OPTRE_FC_Elite_Helmet_Minor,OPTRE_FC_Elite_Helmet_SpecOps,OPTRE_FC_Elite_Helmet_Ultra,OPTRE_FC_Elite_Helmet_Zealot";
OPTRE_HUD_SHIELD_BAR_HEIGHT = "0.057079";
OPTRE_HUD_SHIELD_BAR_POS_X = "0.396875";
OPTRE_HUD_SHIELD_BAR_POS_Y = "0.055897";
force force OPTRE_HUD_SHIELD_BAR_TEXTURE = "\A3\ui_f\data\GUI\RscCommon\RscProgress\progressbar_ca.paa";
OPTRE_HUD_SHIELD_BAR_WIDTH = "0.206250";
force force OPTRE_HUD_TEXTURE_EVA = "\lsd_equipment_bluefor\facewear\gar\_ui\rc_hud_ca.paa";
force force OPTRE_HUD_TEXTURE_MARKIV = "\OPTRE_Suit_Scripts\textures\MarkIV_Hud_No_Crosshair.paa";
force force OPTRE_HUD_TEXTURE_MARKV = "\lsd_equipment_bluefor\facewear\gar\_ui\p1_hud_ca.paa";
force force OPTRE_HUD_TEXTURE_MARKVB = "\OPTRE_Suit_Scripts\textures\MarkVI_Hud_No_Crosshair.paa";
force force OPTRE_HUD_TEXTURE_MARKVI = "\OPTRE_Suit_Scripts\textures\MarkVI_Hud_No_Crosshair.paa";
force force OPTRE_HUD_TEXTURE_MP = "\OPTRE_Suit_Scripts\textures\MP_Hud_No_Crosshair.paa";
force force OPTRE_HUD_TEXTURE_RECON = "\OPTRE_Suit_Scripts\textures\RECON_Hud_No_Crosshair.paa";
force force OPTRE_HUD_TEXTURE_SANGHEILI = "\OPTRE_Suit_Scripts\textures\Sangheili_Hud_No_Crosshair.paa";
force force OPTRE_JUMP_SUITS_SETTING = "";
force force OPTRE_MJOLNIR_ACTIVATE_AI = true;
force force OPTRE_MJOLNIR_CAMSHAKE = false;
force force OPTRE_MJOLNIR_ENABLE_JUMP = false;
force force OPTRE_MJOLNIR_ENABLE_SPARKS_HIT = true;
force force OPTRE_MJOLNIR_ENABLE_SPARKS_SHIELD = false;
OPTRE_MJOLNIR_ENERGY_BAR_ACTIVE = true;
OPTRE_MJOLNIR_ENERGY_BAR_COLOR = [0.5,0.9,0.9,0.8];
OPTRE_MJOLNIR_HUD_ACTIVE_INTRO = false;
OPTRE_MJOLNIR_HUD_OVERLAY = true;
force force OPTRE_MJOLNIR_INCREASED_SPEED = false;
force force OPTRE_MJOLNIR_JUMP_FORWARD = 1;
force force OPTRE_MJOLNIR_JUMP_UP_HIGH = 1;
force force OPTRE_MJOLNIR_JUMP_UP_LOW = 1;
force force OPTRE_MJOLNIR_PREVENT_FALLDAMAGE = true;
force force OPTRE_MJOLNIR_RECOIL_MODIFIER = 0;
force force OPTRE_MJOLNIR_SHIELD_ENERGY = 100;
force force OPTRE_MJOLNIR_SHIELD_ENERGY_AI = 100;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_1 = 6;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_2 = 1;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_3 = 1;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_4 = 1;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_5 = 1;
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_1 = "JMSSL_CommandoHidden_armor,JMSSL_CommandoHidden_armor1,SLTEAM_Nek_Kama","ls_skirata_mandalorian_traditional_vest";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_2 = "SLTEAM_Nek_Kama,SLTEAM_Alpha_vest_LT,SLTEAM_Alpha_vest_CPT,SLTEAM_Alpha_vest_CC,SLTEAM_Clate_Vest,SLTEAM_Alpha_LT_Vest,SLTEAM_Alpha_CPT_Vest,SLTEAM_Alpha_CC_Vest";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_3 = "";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_4 = "";
force force OPTRE_MJOLNIR_SHIELD_MODIFIER_SUITS_5 = "";
...
force force OPTRE_MJOLNIR_SPEED_MODIFIER = 1;
force force OPTRE_MJOLNIR_SUPPRESS_RECOIL = false;
force force OPTRE_POWERED_SUITS_SETTING = "ls_skirata_mandalorian_traditional_vest,JMSSL_CommandoHidden_armor,JMSSL_CommandoHidden_armor1,SLTEAM_Nek_Kama,SLTEAM_Alpha_vest_LT,SLTEAM_Alpha_vest_CPT,SLTEAM_Alpha_vest_CC,SLTEAM_Clate_Vest,SLTEAM_Alpha_LT_Vest,SLTEAM_Alpha_CPT_Vest,SLTEAM_Alpha_CC_Vest";
...
force force TFAR_Teamspeak_Channel_Name = "STAR_WARS";
force force TFAR_Teamspeak_Channel_Password = "1488sl1337";
...
// TGP Cockpit Control
tgp_main_setting_AimSlewBlockMouse = true;
tgp_main_setting_AimSlewSpeed = 1;
tgp_main_setting_AimXFactor = 1;
...
force force UAS_option_chanceCough = 0;
force force UAS_option_chanceRadio = 0;
force force UAS_option_chanceSigh = 0;
force force UAS_option_chanceWhistle = 0;
force force UAS_option_disableOnPlayers = true;
force force UAS_option_disableRadioOnPlayers = false;
force force UAS_option_enableCough = false;
force force UAS_option_enableRadio = false;
force force UAS_option_enableSigh = false;
force force UAS_option_enableWhistle = false;
force force UAS_option_intMultiplierCough = 0;
force force UAS_option_intMultiplierRadio = 0;
force force UAS_option_intMultiplierSigh = 0;
force force UAS_option_intMultiplierWhistle = 0;
force force UAS_option_maxDistCough = 50;
force force UAS_option_maxDistRadio = 50;
force force UAS_option_maxDistRadioInVehicle = 50;
force force UAS_option_maxDistSigh = 50;
force force UAS_option_maxDistWhistle = 50;
force force UAS_option_minIntervalCough = 300;
force force UAS_option_minIntervalRadio = 300;
force force UAS_option_minIntervalSigh = 300;
force force UAS_option_minIntervalWhistle = 300;

// Unit Voice-Over Options
force force UVO_option_clientEnabled = false;
force force UVO_option_deathShoutsVolume = 0;
force force UVO_option_enableSentencesCustom_B1 = false;
force force UVO_option_enableSentencesCustom_BX = false;
force force UVO_option_enableSentencesEast = false;
force force UVO_option_enableSentencesGuer = false;
force force UVO_option_enableSentencesWest = false;
force force UVO_option_enableUVOCustom_B1 = true;
force force UVO_option_enableUVOCustom_BX = true;
force force UVO_option_enableUVOEast = false;
force force UVO_option_enableUVOGuer = false;
force force UVO_option_enableUVOWest = false;
force force UVO_option_killConfirmChanceAI = 0;
force force UVO_option_killConfirmChancePlayer = 0;
force force UVO_option_maxDistDeathShouts = 50;
force force UVO_option_maxDistVoices = 50;
force force UVO_option_soundsSamplePitch = 0.8;

// WebKnight Droids
force force WBK_Droid_b1_damage = "2";
force force WBK_Droid_b2_damage = "5";

// WebKnight HeadLamps
force force WBK_HeadLamps_IsAIActivateHeadlamps = false;
...
force force zen_faction_filter_0_212_Arcus_B1_Faction = false;
...
zen_faction_filter_0_O_CISHumanDivision = true;
zen_faction_filter_0_O_CISHumanDivision_groups = true;
zen_faction_filter_0_O_Kalani = true;
force force zen_faction_filter_0_O_Kalani_groups = false;
...
zen_faction_filter_1_BLU_androids_F = true;
zen_faction_filter_1_BLU_blk_androids_F = true;
...
zen_faction_filter_1_BLU_W_androids_F = true;
...
zen_faction_filter_1_RD501_republic_Faction = true;
...
zen_faction_filter_3_RD501_Editor_Category_statics = true;
